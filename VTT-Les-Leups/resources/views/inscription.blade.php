...
<div class="bg-white p-10 md:w-3/4 lg:w-1/2 sm:w-full mx-auto">
...
<br><br>
    ...
    @csrf
        ...
        <div class="flex items-center mb-5">
            ...
            <input type="text" id="prenom" name="prenom" placeholder="John" class="placeholder-yellow-400 sm:w-full flex-1 py-2 border-b-2 border-gray-400 focus:border-gray-900 
                        text-yellow-600 placeholder-gray-400
                        outline-none">*
        ...
        <div class="flex items-center mb-5">
            ...
            <input type="password" id="mdp" name="mdp" placeholder="********** (min: 7 caractères)" class="placeholder-yellow-400 flex-1 py-2 border-b-2 border-gray-400 focus:border-gray-900 
                        text-yellow-600 placeholder-gray-400
                        outline-none">*
            @if($errors->has('mdp'))
               <br> <h6 class="text-red-500 ml-10">Veuillez saisir un mot de passe (min: 7 caractères)</h6>
            @endif
        </div>
