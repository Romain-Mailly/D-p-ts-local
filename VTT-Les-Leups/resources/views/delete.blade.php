...
<img class="mx-auto" height="600" width="600" src="/images/Adhérants/{{ $profil[0]->util_nom }}.jpg" alt="Photo de {{ $profil[0]->util_prenom}} {{ $profil[0]->util_nom }}">

<p class="text-yellow-500 text-2xl text-center"> Êtes-vous sur de vouloir supprimer le profil de {{ $profil[0]->util_prenom}} {{ $profil[0]->util_nom }} ?</p>

<br><br>

<form class="text-center" action="{{ Route('profil.delete', ['id'=> $profil[0]->util_id]) }}" method="POST">
    @csrf
